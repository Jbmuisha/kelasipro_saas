...
// Host: aws-us-east-1-pooler.supabase.co (or your region)
// Port: 6543
// User: postgres.[project-id]
// Password: SUPABASE_SERVICE_KEY (service_role JWT)
const connectionString = `postgresql://postgres.${projectId}:${process.env.SUPABASE_SERVICE_KEY}@aws-us-east-1-pooler.supabase.co:6543/postgres?sslmode=require`;
